...
export default function Page() {
  ...
  const { user } = useUser()
  // NEW: bumped by AssistantLauncher whenever a note is created/updated/
  // deleted via chat. Including `version` in the fetch effect's deps
  // below means this page refetches automatically instead of only ever
  // updating on a full page reload.
